...
public class MergeSort {
    ...
    private static <Item extends Comparable> Queue<Queue<Item>>
    	...
    	Queue<Queue<Item>> single = new Queue<Queue<Item>>();
    	Iterator<Item> iteration = items.iterator();
    	for(int i = 0; i <items.size(); i++) {
    		Queue<Item> singleQueue = new Queue<Item>();
    		singleQueue.enqueue(iteration.next());
    		single.enqueue(singleQueue);
    	}
        return single;
    }
    ...
    public static <Item extends Comparable> Queue<Item> mergeSort(
    	...
    	if(items.size() == 0)
    		...
    		Queue<Item> one = new Queue<Item>();
    		one.enqueue(items.peek());
    		return one;
    	}
    ...
    public static void main(String[] args) {
    	...
    	students.enqueue("Gaby");
    	students.enqueue("Dylan");
    	students.enqueue("Keith");
        ...
        while(!sortedStudents.isEmpty()){
            System.out.print(sortedStudents.dequeue()+" ");
        }
