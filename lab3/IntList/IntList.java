...
public class IntList {
    ...
    /**
     * return a reverse List of A,destructive
     * @param A
     * @return
     */
    
    public static IntList reverse(IntList A) {
    	IntList firstNode=A,secondNode,thridNode;
    	if(A==null)
    		return null;
    	secondNode=firstNode.rest;   	
    	firstNode.rest=null;
    	while(secondNode!=null) {
    		thridNode=secondNode.rest;
    ...
    public static IntList catenate(IntList A, IntList B) {
        //TODO:  fill in method
    	IntList head,nodeA=A,nodeB=B,nodeNew;
    	if(A==null && B==null)
    		return null;
    	else {
    		if(nodeA!=null) {
